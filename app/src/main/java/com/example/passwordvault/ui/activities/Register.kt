...
class Register : AppCompatActivity(),View.OnClickListener {
        ...
        when(view.id){
            R.id.number1 -> {
                ...
                if(count== 4 && !onConfirmation){
                    binding.demoText.text = "Şifreyi Onayla"
                    onConfirmation = true
                    ...
                    if(password == passwordTemp){
                        ...
                        Toast.makeText(this,"Şifreler Eşleşmemekte!",Toast.LENGTH_SHORT).show()
                        password = ""
                        count = 0
                        onConfirmation = true
                        uncheckPasswordViews()
            ...
            R.id.number0 -> {
                ...
                count++
                if(count== 4 && !onConfirmation){
                    binding.demoText.text = "Şifre Onayla"
                    onConfirmation = true
                    uncheckPasswordViews()
                    count = 0
                    passwordTemp = password
    ...
    override fun onRequestPermissionsResult(
        ...
        if (requestCode == PERMISSIONCODE && grantResults.isNotEmpty() && grantResults[0] == PackageManager.PERMISSION_GRANTED){
            ...
            Toast.makeText(this,"İzin hatası!",Toast.LENGTH_SHORT).show()
            finish()
        }
    }
}
